...
//     return [...tickets].sort((a, b) => b.priority - a.priority); // Sorting by descending priority
//   } else if (ordering === "title") {
//     return [...tickets].sort((a, b) => a.title.localeCompare(b.title)); // Sorting alphabetically by title
//   }
//   return tickets;
// };
